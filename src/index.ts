...
const createWindow = (): void => {
  ...
  const updateIcon = nativeImage.createFromPath("./icons/"+theme+"/update.png");
  const reopenIcon = nativeImage.createFromPath("./icons/"+theme+"/reopenWindow.png");
  const openInBrowserIcon = nativeImage.createFromPath("./icons/"+theme+"/openInBrowser.png");
  const bugReportIcon = nativeImage.createFromPath("./icons/"+theme+"/bugReport.png");
  const closeIcon = nativeImage.createFromPath("./icons/"+theme+"/close.png");
  const infoIcon = nativeImage.createFromPath("./icons/"+theme+"/info.png");
